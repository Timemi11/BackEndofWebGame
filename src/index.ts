...
app.post("/sent-gameproduct/:userId", async (req: Request, res: Response) => {
  ...
  const {prod_id, prod_img, prod_name, prod_desc, prod_original, url, steamurl } = req.body ;
                      ...
                      "contents": [
                        {
                          ...
                          "contents": [
                            {
                              "type": "text",
                              "text": "จาก "+ prod_original.toFixed(0)+" บาท",
                              "style": "italic",
                              "size": "sm",
                        ...
                        {
                          "type": "text",
                          "text": "ลดเหลือ "+ prod_original.toFixed(0)+" บาท",
                          "color": "#22c55e",
                          "size": "md",
                          "style": "normal",
                          "weight": "bold",
