...
app.delete("/products/:id", (req: Request, res: Response) => {
  Product.findByIdAndDelete(req.params.id, req.body).then((products) => {
    res.json(products);
  });
});
...
//   Survey.findById(req.params.id).then((surveys) => {
//     res.json(surveys);
//   });
// });

// app.post("/surveys", (req: Request, res: Response) => {
//   Survey.create(req.body).then((surveys) => {
//     res.json(surveys);
//   });
// });

// app.put("/surveys/:id", (req: Request, res: Response) => {
//   Survey.findByIdAndUpdate(req.params.id, req.body).then((surveys) => {
//     res.json(surveys);
//   });
// });

// app.delete("/surveys/:id", (req: Request, res: Response) => {
//   Survey.findByIdAndDelete(req.params.id, req.body).then((surveys) => {
//     res.json(surveys);
//   });
// });
